defmodule PhotoguessrWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhotoguessrWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhotoguessrWeb.Gettext, "errors", msg, opts)
    end
  end
